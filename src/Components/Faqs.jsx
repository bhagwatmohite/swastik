      ...
      <div className="container-fluid faq-section pb-5">
        <div className="container pb-5 overflow-hidden">
          <div className="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style={{ maxWidth: '800px' }}>
            <h4 className="text-primary">FAQs</h4>
            <h1 className="display-5 mb-4">Frequently Asked Questions</h1>
            <p className="mb-0">Get answers to some of the most common questions about our web development, app development, and digital services.</p>
          </div>
          <div className="row g-5 align-items-center">
            <div className="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
              <div className="accordion accordion-flush bg-light rounded p-5" id="accordionFlushSection">
                <div className="accordion-item rounded-top">
                  ...
                  <div id="flush-collapseOne" className="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushSection">
                    <div className="accordion-body">We specialize in web development, mobile app development, e-commerce solutions, and SEO services. Our goal is to help businesses thrive online by creating custom, user-friendly websites and apps, and enhancing their visibility through effective SEO strategies.</div>
                  </div>
                </div>
                <div className="accordion-item">
                  <h2 className="accordion-header" id="flush-headingTwo">
                  ...
                  <div id="flush-collapseTwo" className="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushSection">
                    <div className="accordion-body">The timeline for web or mobile app development depends on the complexity of the project. Typically, a standard website can take 4-6 weeks, while a mobile app may take 8-12 weeks. We'll provide a detailed timeline during the project planning phase.</div>
                  </div>
                </div>
                <div className="accordion-item">
                  <h2 className="accordion-header" id="flush-headingThree">
                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                      Do you offer e-commerce development services?
                    </button>
                  </h2>
                  <div id="flush-collapseThree" className="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushSection">
                    <div className="accordion-body">Yes, we provide comprehensive e-commerce development services, including custom online store design, payment gateway integration, and features that enhance user experience and drive sales.</div>
                  </div>
                </div>
                <div className="accordion-item">
                  <h2 className="accordion-header" id="flush-headingFour">
                  ...
                  <div id="flush-collapseFour" className="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushSection">
                    <div className="accordion-body">Our SEO services include optimizing your website's content, structure, and performance for search engines. We follow best practices in SEO, including keyword research, on-page optimization, and technical SEO, to improve your website's ranking and visibility.</div>
                  </div>
                </div>
                <div className="accordion-item">
                  <h2 className="accordion-header" id="flush-headingFive">
                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFive" aria-expanded="false" aria-controls="flush-collapseFive">
                      Can you help with maintaining and updating my website or app?
                    </button>
                  </h2>
                  <div id="flush-collapseFive" className="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushSection">
                    <div className="accordion-body">Absolutely! We offer ongoing maintenance and support services to ensure that your website or mobile app stays up to date, secure, and fully functional. We can also help with updates, new features, and performance optimization as needed.</div>
                  </div>
                </div>
                <div className="accordion-item rounded-bottom">
                  <h2 className="accordion-header" id="flush-headingSix">
                  ...
                  <div id="flush-collapseSix" className="accordion-collapse collapse" aria-labelledby="flush-headingSix" data-bs-parent="#accordionFlushSection">
                    <div className="accordion-body">The cost of developing a website or mobile app varies depending on the project's requirements, complexity, and features. We offer custom pricing based on your specific needs. Contact us for a detailed quote.</div>
                  </div>
                </div>
              </div>
            </div>
